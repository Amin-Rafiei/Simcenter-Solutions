...
Code::Blocks>Project>Set Program's arguments>file name with txt format (Input_FIle.txt) is written. The output of the program is saved in the Result.txt file.
